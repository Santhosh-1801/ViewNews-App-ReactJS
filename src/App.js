...
function App() {
  ...
  const fetchNews=async()=>{
    try {
      ...
      const newsData=await axios.get(`${proxyURL}newsapi.org/v2/top-headlines?country=in&apiKey=${process.env.REACT_APP_API_KEY}&category=${category}&pageSize=${loadmore}`)
